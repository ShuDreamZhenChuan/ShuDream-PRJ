...
{
    public partial class NewDeviceForm : Smart.Core.StandardForm
    {
        ...
        {
            _resc = new ResourceManager(typeof(NewDeviceForm));
            InitializeComponent();
        }
        ...
        private void LoadLanguage(string languagetype)
        {
            try
            {
                this.Text = _resc.GetString("adddevice");

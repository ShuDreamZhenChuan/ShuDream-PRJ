...
namespace Smart.ToolUtil
{
    class FTPControl
    {
        ...
        public FTPControl(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
        ...
        public static void DeleteOrderDirectory(string ftpServerIP, string folderToDelete, string ftpUserID, string ftpPassword)
        {
            try{
                ...
                {
                    FTPControl fw = new FTPControl(ftpServerIP, folderToDelete, ftpUserID, ftpPassword);
                    //进入订单目录

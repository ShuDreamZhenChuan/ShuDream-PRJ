...
namespace Smart.ToolUtil
{
    ...
    /// </summary>
    public class TCPCominication : IDisposable
    {
        ...
        public TCPCominication(int listenPort)
        ...
        public TCPCominication(IPEndPoint localEP)
        ...
        /// <param name="listenPort">监听的端口</param>
        public TCPCominication(IPAddress localIPAddress, int listenPort)
        {
